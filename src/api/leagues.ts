...
export const createLeague = async (body: CreateLeagueBody): Promise<components['schemas']['League']> => {
    const res = await api.post<components['schemas']['League']>('/api/leagues', body);
    return res.data;
};
